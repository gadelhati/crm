...
import com.crm.persistence.payload.request.DTORequestRole;
import com.crm.persistence.payload.response.DTOResponseRole;
import com.crm.service.ServiceRole;
...
public class ControllerRole implements ControllerInterface<DTOResponseRole, DTORequestRole> {
    ...
    public ResponseEntity<Page<DTOResponseRole>> retrieve(@RequestParam(name = "key", defaultValue = "", required = false) String key, @RequestParam(name = "key", defaultValue = "", required = false) String value, Pageable pageable){
